...
function runAllTests() {
  const tests = [
    ...
    { name: 'Widgets', run: require('./ui/Widgets.test').run },
    ...
    { name: 'StarHunterBanner', run: require('../example/star-hunter/tests/ui/Banner.test').run },
    { name: 'StarHunterHUD', run: require('../example/star-hunter/tests/ui/HUD.test').run },
    { name: 'StarHunterModal', run: require('../example/star-hunter/tests/ui/Modal.test').run },
